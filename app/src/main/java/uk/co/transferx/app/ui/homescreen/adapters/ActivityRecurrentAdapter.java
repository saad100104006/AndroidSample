...
public class ActivityRecurrentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<Transaction> transactions;
    private Context mContext;
    private ActivityAllAdapter.ItemClickListener mClickListener;

    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;

    public ActivityRecurrentAdapter(Context context, ArrayList<Transaction> transactions) {
    ...
    public void setClickListener(ActivityAllAdapter.ItemClickListener clickListener) {
