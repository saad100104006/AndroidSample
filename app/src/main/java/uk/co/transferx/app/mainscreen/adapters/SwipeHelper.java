...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    private final static int BUTTON_WITH_DP = 46;
    private final static int TEXT_SIZE_SP = 7;
    ...
    public class UnderlayButton {
        ...
        public void onDraw(Canvas canvas, RectF rect, int pos) {
            ...
            float x = cWidth / 2f - rectText.width() / 2f - rectText.left;
            float y = cHeight / 2f + rectText.height() / 2f - rectText.bottom;
