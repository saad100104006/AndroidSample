...
class ActivityRecurrentAdapter(private val mContext: Context, private val transactions: ArrayList<Transaction>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
