...
class RecipientsAdapter(private val mContext: Context, private val transactions: ArrayList<Transaction>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var clickListener: ActivityAllAdapter.ItemClickListener? = null
    ...
    fun setClickListener(clickListener: ActivityAllAdapter.ItemClickListener) {
    ...
    inner class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        protected var flagImg: ImageView
